...
namespace Zephyr.Filesystem
{
    ...
    public class Clients
    {
        ...
        public AzureClient azure { get; set; } = null;
        ...
        public AzureClient AzureInitialize()
        {
            string varName = "AzureStorageConnectionString";
            string connStr = Environment.GetEnvironmentVariable(varName);
            this.azure = new AzureClient(connStr);
            return this.azure;
        }

        public AzureClient AzureInitialize(string connectionString)
        {
            this.azure = new AzureClient(connectionString);
            return this.azure;
        }
