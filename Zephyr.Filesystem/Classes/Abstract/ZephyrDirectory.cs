...
namespace Zephyr.Filesystem
{
    ...
    public abstract class ZephyrDirectory
    {
        ...
        /// <summary>
        /// Returns the Directory Separator Character for this Directory Implementation
        /// </summary>
        ...
        public abstract bool Delete(bool recurse = true, bool stopOnError = true, bool verbose = true, String callbackLabel = null, Action<string, string> callback = null);
