...
{
    /// <summary>
    /// The implementation of ZephyrFile using Local-based FileSystem.
    /// </summary>
    public class LocalZephyrFile : ZephyrFile
    {
        /// <summary>
        /// The name of the file on the local system.
        /// </summary>
        ...
        /// <summary>
        /// The Fullname or URL of the file on the local system.
        /// </summary>
        ...
        public LocalZephyrFile(string fullName) : base(fullName) { }

        /// <summary>
        /// Implementation of the ZephyrFile Open method on the local system.
        /// </summary>
        ...
        /// <returns>The open Stream for the LocalZephyrFile.</returns>
        ...
        /// <summary>
        /// Implementation of the ZephyrFile Close method on the local system.
        /// </summary>
        /// <param name="callbackLabel">Optional "label" to be passed into the callback method.</param>
        /// <param name="callback">Optional method that is called for logging purposes.</param>
        ...
        /// <summary>
        /// Implementation of the ZephyrFile Flush method on the local system.
        /// </summary>
        /// <param name="callbackLabel">Optional "label" to be passed into the callback method.</param>
        /// <param name="callback">Optional method that is called for logging purposes.</param>
        ...
        /// <summary>
        /// Implementation of the ZephyrFile Create method on the local system.
        /// </summary>
        /// <param name="overwrite">Will overwrite the file if it already exists.</param>
        /// <param name="callbackLabel">Optional "label" to be passed into the callback method.</param>
        /// <param name="callback">Optional method that is called for logging purposes.</param>
        /// <returns>An instance of a LocalZephyrFile.</returns>
        ...
        /// <summary>
        /// Implementation of the ZephyrFile CreateFile method on the local system.
        /// </summary>
        ...
        {
            return new LocalZephyrFile(fileName);
        }

        /// <summary>
        /// Implementation of the ZephyrDirectory CreateDirectory method on the local system.
        /// </summary>
        ...
        {
            return new LocalZephyrDirectory(dirName);
        }

        /// <summary>
        /// Implementation of the ZephyrDirectory Delete method on the local system.
        /// </summary>
